...
<p align="center"><b>
 ...
 <a href="#---trynfo-project-------">README em Português 🇧🇷</a>
  </b>
</p>
<h1 align="center">
  Tryunfo Project
...
<table>
    <tr>
      <td><br>
        <p align="left">
        Neste projeto criamos um jogo, parecido com o Super Trunfo! Onde a pessoa usuária, deve criar um baralho, com tema livre, adicionar e remover cartas, visualizar todas as cartas e jogar com o baralho criado.
</p>
   <p align="left">Ler e alterar o estado do componente, inicializar o componente com um estado pré-definido, atualizar estado. Capirutar eventos no React, criar formulários com JSX. E transitar informações dos componentes pais para os filhos com o uso das callbacks.
