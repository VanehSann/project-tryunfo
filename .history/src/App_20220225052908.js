...
class App extends React.Component {
  ...
  onInputChange({ target }) {
    ...
    this.setState({
      ...
      const { cardName, cardAttr1, cardAttr2, cardAttr3 } = this.state;
      this.setState({
        isSaveButtonDisabled: this.validaTodos([cardName, cardAttr1, cardAttr2, cardAttr3]),
      });
    });
  }
...
validaTodos = ([value, value2, value3]) => {
  ...
  if (valor1 === true || valor2 === true || valor3 === true || text === false) {
    return true;
  }
  return false;
}
