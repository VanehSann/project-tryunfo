  ...
  onInputChange({ target }) {
    ...
    this.setState({
      ...
      this.setState({
        ...
        this.validaTodos([cardAttr1, cardAttr2, cardAttr3]) || this.validation(target.value),
      });
    });
  }

  validationM = ([value, value2, value3]) => {
    const nob = 91;
    if (value >= nob || value2 >= nob || value3 >= nob) {
      return true;
    }
    return false;
  }
