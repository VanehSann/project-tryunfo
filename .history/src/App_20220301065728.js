  ...
  return (
    <div>
      ...
      <label htmlFor="filtro">
        ...
        // se filtro === todas não filtra nada
        // se filtro for igual a muito raro
          .filter((card) => ((card.cardRare.includes('muito').includes(raroFiltro)
            ? card.cardRare.includes('muito').includes(raroFiltro) : card.cardRare.includes(raroFiltro)))
          .map((card) => (
            <div key={ card.cardName }>
              <Card
                cardName={ card.cardName }
